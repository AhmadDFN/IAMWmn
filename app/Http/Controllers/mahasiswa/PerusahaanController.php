...
class PerusahaanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mahasiswa.perusahaan.data', $data);
    }
    ...
    public function create()
    {
        ...
        return view("mahasiswa.perusahaan.form", $data);
    }
    ...
    public function show(Perusahaan $perusahaan)
    {
        ...
        // dd($lokers);
        return view("mahasiswa.perusahaan.show", compact('data', 'perusahaan', 'title', 'lokers', 'jurusans'));
    }
