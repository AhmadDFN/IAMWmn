...
-- membuang struktur untuk table iamwmdn.kecamatans
...
CREATE TABLE IF NOT EXISTS `kecamatans` (
  ...
  CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`regency_id`) REFERENCES `kotas` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- Membuang data untuk tabel iamwmdn.kecamatans: ~7.377 rows (lebih kurang)
