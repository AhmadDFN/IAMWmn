                ...
                <div class="row gx-5">
                    ...
                    <div class="col">
                        ...
                        <a class="btn btn-primary float-end ms-1 me-1"
                            href="{{ url('lamar/' . @$loker->id . '/detail/perusahaan/1') }}" role="button">Interview</a>
                        <a class="btn btn-success float-end ms-1 me-1"
                            href="{{ url('lamar/' . @$loker->id . '/detail/perusahaan/3') }}" role="button">Diterima</a>
                        <a class="btn btn-danger float-end ms-1 me-1"
                            href="{{ url('lamar/' . @$loker->id . '/detail/perusahaan/2') }}" role="button">Ditolak</a>
                    </div>
                </div>
            </div>
            <div class="bg-secondary card-body">
