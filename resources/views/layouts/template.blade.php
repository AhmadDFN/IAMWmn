            ...
            <div class="bg-secondary rounded-top p-4">
                <div class="row">
                    <div class="col-12 col-sm-6 text-center text-sm-start">
                        &copy; <a href="https://www.instagram.com/wearnesmadiun/" target="_blank">IAMW</a>, iRzella - All Right Reserved. 
                    </div>
                    <div class="col-12 col-sm-6 text-center text-sm-end">
                        ...
                        <br>Distributed By: <a href="https://www.linkedin.com/in/ahmaddfn/" target="_blank">Ahmad Dany FN</a>
                    </div>
                </div>
            </div>
        </div>
