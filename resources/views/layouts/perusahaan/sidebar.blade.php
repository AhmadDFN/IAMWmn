...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            <a href="{{ url('perusahaan') }}" class="nav-item nav-link {{ $title == 'Dashboard' ? 'active' : '' }}"><i
                    class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
            <div class="nav-item dropdown">
                <a href="#"
                    class="nav-link dropdown-toggle {{ (($title == 'Loker' ? 'active' : $title == 'Lokerku') ? 'active' : $title == 'Lamar') ? 'active' : '' }}"
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="{{ url('perusahaan/lamar') }}"
                        class="nav-item nav-link {{ $title == 'Lamar' ? 'active' : '' }}">Lamaranku</a>
                </div>
            </div>
            {{--  <a href="{{ url('perusahaan/perusahaan') }}"
